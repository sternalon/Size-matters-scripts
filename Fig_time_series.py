...
def produce_bar_figure_panel(datapath,file_extension,field_name, Delta_list,nrows,ncols,plot_num,color_vec,y_label_list,title_list,Gladstone_A,scale_by_control,ax):
	...
	color_vec=np.array(['blue','red','green','darkgrey'])
	#ind2=ind[:]+width/2.
	width=.35
	number_of_years=60
	...
	#for j in np.array([1,2,3]):
		...
		#        x1=0.3 ; y1=1550; x2=8.5; y2=1050
		#	plt.plot(np.array([x1,x2]),np.array([y1,y2]),linestyle='--',color='red')
		#        x1=0.5 ; y1=800; x2=8.7; y2=1100
		#	plt.plot(np.array([x1,x2]),np.array([y1,y2]),linestyle='--',color='green')
		#        #plt.annotate('', xy=(x1, y1),  xycoords='data',  xytext=(x2, y2), textcoords='data', size=10, arrowprops=dict(arrowstyle="simple", color='red'))
...
def main():
	...
	#field_list=np.array(['mass','melt','CN','Volume'])
	...
	y_label_list = {'mass': 'Iceberg Mass (Gt)', 'CALVING':'Calving Flux (Gt/year)', 'CN':'Sea Ice Concentration (m$^2$)' ,'HI': 'Sea Ice Thickness (m$^3$)',\
			'melt':'Freshwater Flux (Gt/year)', 'Volume':'Volume (m$^{3}$'}
	...
	#title_list = {'Control':'F$_{FR}$', 'Delta1': 'L=60m', 'Delta2':'L=100m', 'Delta3':'L=200m' , 'Delta4': 'L=350m' , 'Delta5': 'L=500m','Delta6': 'L=700m',\
	#		'Delta7':'L=900m', 'Delta8':'L=1200m$' , 'Delta9': 'L=1600m' , 'Delta10': 'L=2200m'}
	#title_list = {'Control':'F$_{FR}$', 'Delta1': '60', 'Delta2':'100', 'Delta3':'200' , 'Delta4': '350' , 'Delta5': '500','Delta6': '700',\
	#		'Delta7':'900', 'Delta8':'1200$' , 'Delta9': '1600' , 'Delta10': '2200'}
	title_list = {'Control':'F$_{FR}$', 'Delta1': '62', 'Delta2':'104', 'Delta3':'209' , 'Delta4': '426' , 'Delta5': '518','Delta6': '728',\
			'Delta7':'920', 'Delta8':'1246$' , 'Delta9': '1659' , 'Delta10': '2285'}
	...
	#for plot_num in range(nrows*ncols):
		...
		text(1,1,letter_labels[plot_num], ha='right', va='bottom',transform=ax.transAxes,fontsize=16)
	...
	if save_figure==True:
		plt.savefig('paper_figures/Fig_time_series.png',dpi=300,bbox_inches='tight')
	plt.show()
